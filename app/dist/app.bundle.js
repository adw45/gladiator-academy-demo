...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _vueSocketMin = __webpack_require__(1);

	var _vueSocketMin2 = _interopRequireDefault(_vueSocketMin);
	...
	Vue.use(_vueSocketMin2.default, window.location.host, _store2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!function () {
	  var o =  true ? __webpack_require__(34) : window.io;if (!o) throw new Error("[Vue-Socket.io] cannot locate Socket.io");var n = { install: function install(n, t) {
	      if (!t) throw new Error("[Vue-Socket.io] cannot locate connection");if ("string" == typeof t) var e = o(t);else if ("object" == (typeof t === "undefined" ? "undefined" : (0, _typeof3.default)(t))) var e = t;var c = e.onevent;e.onevent = function (o) {
	        var n = o.data || [];c.call(this, o), o.data = ["*"].concat(n), c.call(this, o);
	      };var i = ["connect", "error", "disconnect", "reconnect", "reconnect_attempt", "reconnecting", "reconnect_error", "reconnect_failed"];n.mixin({ created: function created() {
	          var o = this;this.$options.hasOwnProperty("sockets") && (e.on("*", function (n, t) {
	    ...
	    } };"object" == ( false ? "undefined" : (0, _typeof3.default)(exports)) ? module.exports = n :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
	  }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : window.Vue && (window.VueSocketio = n);
	}();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mapSelect = __webpack_require__(87);

	var _mapSelect2 = _interopRequireDefault(_mapSelect);

	var _scoreboard = __webpack_require__(88);

	var _scoreboard2 = _interopRequireDefault(_scoreboard);

	var _team = __webpack_require__(89);
	...
	var router = new VueRouter({
	    routes: [{ path: '/', component: _startRoom2.default, props: { title: "Gladiator Academy" } }, { name: 'room', path: '/room/:id', component: _matchRoom2.default }]
	});
...
/***/ (function(module, exports) {
	...
	var startRoom = Vue.component('start-room', {
	    props: ['title'],
	...
	var playerSelect = Vue.component('player-select', {
	    ...
	    computed: {
	        ...
	        isLeader: function isLeader() {
	            var thisPlayer = _lodash2.default.find(this.$store.state.playerSelect.teams.red.players, { id: this.$store.state.playerSelect.id });
	            if (!thisPlayer) {
	                thisPlayer = _lodash2.default.find(this.$store.state.playerSelect.teams.blue.players, { id: this.$store.state.playerSelect.id });
	            }
	            return thisPlayer && thisPlayer.leader;
	        },
	        sameTeam: function sameTeam() {
	            if (this.team === 'red' && _lodash2.default.find(this.$store.state.playerSelect.teams.red.players, { id: this.$store.state.playerSelect.id })) {
	                return true;
	            }
	            if (this.team == 'blue' && _lodash2.default.find(this.$store.state.playerSelect.teams.blue.players, { id: this.$store.state.playerSelect.id })) {
	                return true;
	            }
	            return false;
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(62)(module)))
